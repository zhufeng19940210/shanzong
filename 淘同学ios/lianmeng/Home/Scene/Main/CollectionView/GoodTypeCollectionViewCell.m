//  GoodTypeCollectionViewCell.m
//  lianmeng
//  Created by zhufeng on 2018/12/23.
//  Copyright © 2018 zhuchao. All rights reserved.
#import "GoodTypeCollectionViewCell.h"
#import <EasyIOS/EasyIOS.h>
#import <Masonry/Masonry.h>
@interface GoodTypeCollectionViewCell()
...
@implementation GoodTypeCollectionViewCell
-(instancetype)initWithFrame:(CGRect)frame{
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = [UIColor whiteColor];
        _imageView = [[UIImageView alloc]initWithFrame:CGRectMake((frame.size.width -120)/2, 5, 120, 120.0f)];
        _imageView.clipsToBounds = YES;
        [self addSubview:_imageView];
        
        _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(6.5f, 122.0f, frame.size.width - 13.0f, 34.0f)];
        ...
        _yjBgview = [[UIImageView alloc]initWithFrame:CGRectMake(0, 125.0f, frame.size.width, 21.0f)];
        _yjBgview.image = [UIImage imageNamed:@"yugukuang-1"];
        
        [self addSubview:_yjBgview];
        
        _iconImageView = [[UIImageView alloc]initWithFrame:CGRectMake(5.0f, 130.0f, 16.0f, 16.0f)];
        ...
        _originPrice= [[UILabel alloc] initWithFrame:CGRectMake(5.0f, 120.0f+42.0f, 90.0f, 12.0f)];
        ...
        _salesCount= [[UILabel alloc] initWithFrame:CGRectMake(frame.size.width - 75.0f, 120.0f+42.0f,70.0f, 12.0f)];
        ...
        _price = [[UILabel alloc] initWithFrame:CGRectMake(5.0f, 125.0f+42.0f + 22.0f, 90.0f, 21.0f)];
        ...
        _youhuiquanView = [[UIImageView alloc]initWithFrame:CGRectMake(frame.size.width -  65.0f, 125.0f+42.0f + 22.0f, 60.0f, 20.0f)];
